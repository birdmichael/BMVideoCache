...
class MockURLProtocol: URLProtocol {
    ...
    static func registerMockResponse(for url: URL, data: Data, statusCode: Int = 200, contentType: String = "video/mp4", error: Error? = nil) {
        let response = HTTPURLResponse(url: url, statusCode: statusCode, httpVersion: "HTTP/1.1", headerFields: ["Content-Type": contentType, "Accept-Ranges": "bytes"])!
